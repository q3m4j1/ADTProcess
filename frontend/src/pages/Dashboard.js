      ...
      <div className="hero-gradient rounded-2xl p-8 text-white relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <p className="text-blue-100 max-w-lg mb-6">
            Enterprise HL7 message routing platform. Configure environments, manage tenants,
            and send templated messages across your healthcare infrastructure.
          </p>
          <div className="flex gap-3">
            ...
            {isAdmin && (
              <Button
                ...
                onClick={() => document.querySelector('[data-testid="settings-btn"]')?.click()}
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-slate-200 bg-slate-50">
                    <th className="text-left p-3 text-xs font-semibold text-slate-500 uppercase">Timestamp</th>
                    <th className="text-left p-3 text-xs font-semibold text-slate-500 uppercase">Environment</th>
                    <th className="text-left p-3 text-xs font-semibold text-slate-500 uppercase">Tenant</th>
                    <th className="text-left p-3 text-xs font-semibold text-slate-500 uppercase">Template</th>
                    <th className="text-left p-3 text-xs font-semibold text-slate-500 uppercase">MRN</th>
                    <th className="text-left p-3 text-xs font-semibold text-slate-500 uppercase">Visit #</th>
                ...
                <tbody>
                  {filteredLogs.map((log) => (
                    ...
                    >
                      ...
                      <td className="p-3 text-sm font-medium text-slate-900">{log.environment_name}</td>
                      ...
                      <td className="p-3">
                        <Badge
                          className={log.status === 'sent' ? 'status-sent' : 'status-failed'}
                        >
                          {log.status === 'sent' ? (
